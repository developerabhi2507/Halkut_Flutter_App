          ...
          Column(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ElevatedButton(
                    style: const ButtonStyle(backgroundColor: MaterialStatePropertyAll(AppConstants.backgroundColor)),
                    onPressed: () {
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const Text('Account Settings',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400),), // <-- Text
                        const SizedBox(
                          width: 5,
                        ),
                        SizedBox(
              ...
              ElevatedButton(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Text('App Settings',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400),), // <-- Text
                    const SizedBox(
                      width: 5,
                    ),
                    SizedBox(
              ...
              ElevatedButton(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Text('Rate us on Appstore',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400),), // <-- Text
                    const SizedBox(
                      width: 5,
                    ),
                    SizedBox(
              ...
              ElevatedButton(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Text('Help',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400),), // <-- Text
                    const SizedBox(
                      width: 5,
                    ),
                    SizedBox(
              ...
              ElevatedButton(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Text('Sign out',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400),), // <-- Text
                    const SizedBox(
                      width: 5,
                    ),
                    SizedBox(
